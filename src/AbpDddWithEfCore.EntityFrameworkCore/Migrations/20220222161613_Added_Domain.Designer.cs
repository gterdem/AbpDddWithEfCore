...
{
    [DbContext(typeof(AbpDddWithEfCoreDbContext))]
    [Migration("20220222161613_Added_Domain")]
    partial class Added_Domain
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbpDddWithEfCore.Blogs.Blog", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("AbpDddWithEfCore.Blogs.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AbpDddWithEfCore.Blogs.Post", b =>
                {
                    b.HasOne("AbpDddWithEfCore.Blogs.Blog", null)
                        .WithMany("Posts")
